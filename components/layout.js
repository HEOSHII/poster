...
export default function Layout({children}) {
    ...
    return (
        <div className={`w-full h-full min-h-screen font-mulish flex justify-center item-center dark:bg-backgdound-dark`}>
            ...
            <main className="relative container mt-20">
            ...
            <div className="fixed bottom-0 left-0 w-full h-[150px] bg-gradient-to-t from-background-light dark:from-background-dark to-transparent">
            </div>
        </div>
    );
}