...
export default function Message({children, avatar, title, description, userName, user, id}) {
    return(
            <motion.div  
                    ...
                    key={id}
                    className="relative rounded border border-opacity-20 dark:border-opacity-20 border-textColor-light dark:border-textColor-dark bg-container-light dark:bg-container-dark py-8 px-6 shadow-sm z-0 cursor-pointer overflow-hidden"
                    >
                ...
                <div className="flex flex-wrap items-center justify-between h-6 mt-3 transition-all">
